...
static const double fm_exp10_p[] __attribute__ ((aligned(16))) = {
...
static const double fm_exp10_q[] __attribute__ ((aligned(16))) = {
...
static const float fm_exp10f_p[]  __attribute__ ((aligned(16))) = {
 0.2063216740311022f,
 0.5420251702225484f,
 1.171292686296281f,
 2.034649854009453f,
